...
|----------|:---------:|---------:|
| dfa      | text here | text here |
| mfdfa    | text here | text here |
| dcca     | text here | text here |
| mra      | text here | text here |
| mrla     | text here | text here |
| fgn_sim  | text here | text here |
"
...
(DFA) [@pengMosaicOrganizationDNA1994] is INSERT KEY QUESTION HERE. DFA
