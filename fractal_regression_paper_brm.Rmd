...
-   Unanswered questions about the methods
    ...
    -   Systematic evaluation of simulated data for the bivariate mfdfa methods to better understand the methods, particularly when cross-overs are present.
