...
Figure \## clearly represents the expected results. There is a strong positive relationship $\beta(s,l)$ at lag 50 that clearly approaches 1.0 but is close to zero elsewhere.

In terms of the empirical data, below we apply MLRA to the COPxy data for the firm and the foam examples. We investigate up to a lag of 100.
