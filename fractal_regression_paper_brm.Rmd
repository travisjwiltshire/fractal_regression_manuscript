...
In the example above, we observe that the is a crossover point at INSERT VALUE. And, that there are two distinct scaling relationships: INSERT ALPHAS. The postural control literature has shown evidence of this type of dynamic before with short time scales displaying more DESCRIBE and longer time scale exhibiting DESCRIBE (CITE).
...
Turning next to the empirical balance data, we apply DCCA to the COPx and COPy data.
